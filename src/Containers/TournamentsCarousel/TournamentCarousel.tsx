...
import { TournamentsGrid } from '../../Components/TournamentsGrid/TournamentsGrid'
import { getTournamentPageInfo } from './utils/getTournamentPageInfo'
import { SkeletonGrid } from '../../Components/SkeletonGrid/SkeletonGrid'
import { DocumentNode } from 'graphql'
import { useQuery } from '@apollo/client'

export function TournamentsCarousel (props: { query: DocumentNode, coordinates?: string, heading: string }) {
	...
	const { loading, data, error } = useQuery(props.query, {variables: {page: 1, perPage: 9, coordinates: props.coordinates}});
	...
	return(
		<Container background='white' maxW='container.xl' mx={{sm: '20px', lg: '42px', xl: 'auto'}} borderRadius='20px' p='32px'>
			...
			{ data && 
                <>
                	<Heading size='xl' color='black'>{props.heading}</Heading>
